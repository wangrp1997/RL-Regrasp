...
class RobotiqGripper( mm.Instrument ):
    ...
    def __init__(self, portname, slaveaddress=9):
        """Create a RobotiqGripper objects use to control Robotiq grippers
    ...
    def _buildRegisterDic(self):
        ...
        gOBJdic[0]="Fingers are in motion towards requested position. No objects detected."
        ...
        gOBJdic[3]="Fingers are at requested position. No objects detected or objects has been loss / dropped."
